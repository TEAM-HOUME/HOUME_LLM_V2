"""Base classes for LLM-powered routers chains."""
...
class LLMRouterChain(RouterChain):
    """A routers chain that uses an LLM chain to perform routing.
...
class RouterOutputParser(BaseOutputParser[dict[str, str]]):
    """Parser for output of routers chain in the multi-prompt chain."""
