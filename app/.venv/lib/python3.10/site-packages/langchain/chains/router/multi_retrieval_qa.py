...
class MultiRetrievalQAChain(MultiRouteChain):
    """A multi-route chain that uses an LLM routers chain to choose amongst retrieval
    qa chains."""
    ...
    default_chain: Chain
    """Default chain to use when routers doesn't map input to one of the destinations."""
