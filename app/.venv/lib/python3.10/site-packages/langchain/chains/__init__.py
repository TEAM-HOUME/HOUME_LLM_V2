...
_module_lookup = {
    ...
    "LLMRouterChain": "langchain.chains.routers",
    "MultiPromptChain": "langchain.chains.routers",
    "MultiRetrievalQAChain": "langchain.chains.routers",
    "MultiRouteChain": "langchain.chains.routers",
    "RouterChain": "langchain.chains.routers",
